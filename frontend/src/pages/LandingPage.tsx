...
const FEATURES = [
   {
      ...
      description:
         "Ekstraksi data otomatis dari dokumen CV Anda secara akurat menggunakan teknologi NLP.",
   },
   {
      icon: <Search className="w-6 h-6" />,
      title: "Job Matching Engine",
      description:
         "CVision mencocokkan kompetensi Anda dengan kriteria spesifik lowongan pekerjaan secara objektif.",
   },
   {
      icon: <Layout className="w-6 h-6" />,
      title: "Career Roadmap",
      description:
         "Rekomendasi langkah karir selanjutnya berdasarkan analisis gap kompetensi dari CVision.",
   },
   {
      icon: <Shield className="w-6 h-6" />,
      title: "Data Privacy",
      description:
         "Keamanan data dokumen Anda terlindungi dengan enkripsi standar industri di dalam sistem CVision.",
   },
   {
      icon: <Users className="w-6 h-6" />,
      title: "Talent Insights",
      description:
         "Analisis tren pasar kerja terkini untuk membantu Anda menyesuaikan keahlian yang dibutuhkan.",
   },
   {
      icon: <Sparkles className="w-6 h-6" />,
      title: "Resume Optimizer",
      description:
         "Saran perbaikan struktur dan kata kunci dari CVision agar CV Anda lebih ramah sistem ATS.",
   },
];
   ...
   return (
      <div className="min-h-screen bg-black text-white font-sans selection:bg-white/20 scroll-smooth snap-y snap-mandatory overflow-y-auto h-screen relative">
         <div className="fixed inset-0 pointer-events-none -z-10 overflow-hidden">
            ...
            <div className="absolute top-0 left-1/4 w-125 h-125 bg-white/2 blur-[120px] rounded-full" />
            <div className="absolute bottom-0 right-1/4 w-150 h-150 bg-white/3 blur-[150px] rounded-full" />
         </div>
         ...
         <section className="relative min-h-svh flex items-center justify-center pt-40 md:pt-48 pb-12 snap-start bg-black">
            <div className="max-w-7xl mx-auto px-5 md:px-8 w-full grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-12 items-center">
               <div className="text-center lg:text-left space-y-8 md:space-y-8 animate-in fade-in slide-in-from-bottom-4 lg:slide-in-from-left-4 duration-1000">
                  ...
                  <h1 className="text-4xl md:text-7xl font-semibold tracking-tight leading-[1.1] md:leading-[1.05] text-balance text-white">
                     ...
                     <span className="text-zinc-600 italic underline decoration-zinc-800 underline-offset-8">
                        Bersama CVision
                     </span>
                  </h1>

                  <p className="max-w-lg mx-auto lg:mx-0 text-sm md:text-xl text-zinc-400 leading-relaxed font-normal">
                     CVision menggunakan AI untuk menganalisis dokumen CV dan
                     mencocokkannya dengan lowongan pekerjaan guna mempercepat
               ...
               <div className="hidden lg:block relative animate-in fade-in slide-in-from-right-4 duration-1000 delay-200">
                     ...
                     <div className="space-y-6">
                        ...
                        <div className="aspect-square rounded-xl bg-black/40 border border-white/5 flex flex-col p-6 gap-6">
                           <div className="flex items-center gap-4 border-b border-white/10 pb-6">
                              <div className="w-14 h-14 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-2xl font-semibold text-white">
                                 CV
                              </div>
                           ...
                           <div className="flex-1 space-y-4">
                              ...
                              <div className="grid grid-cols-2 gap-4 mt-8">
                                 <div className="h-24 rounded-xl bg-white/5 border border-white/10 p-4 flex flex-col justify-between">
                                    <div className="text-[10px] font-medium uppercase text-zinc-500 tracking-[0.2em]">
                                       Accuracy
                                    </div>
                  ...
                  <div className="absolute -top-12 -right-12 w-64 h-64 bg-white/3 blur-[100px] -z-10 rounded-full" />
                  <div className="absolute -bottom-12 -left-12 w-64 h-64 bg-white/3 blur-[100px] -z-10 rounded-full" />
               </div>
            </div>
         </section>
         ...
         <section
            id="features"
            className="min-h-screen flex items-center justify-center bg-linear-to-b from-zinc-900 to-black border-y border-white/5 snap-start pt-40 pb-24 md:pt-48 md:pb-32"
         >
            <div className="max-w-7xl mx-auto px-5 md:px-8 w-full">
               <div className="flex flex-col md:flex-row justify-between items-center md:items-end mb-10 md:mb-16 gap-6 text-center md:text-left">
                  <div className="max-w-xl space-y-4">
                     ...
                     <p className="text-sm md:text-xl text-zinc-400 font-normal">
                        Sistem terintegrasi untuk pengelolaan karir yang lebih
                        efisien.
                     </p>
                  </div>
               ...
               <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                  {FEATURES.map((feature, idx) => (
                     <Card
                        key={idx}
                        className="bg-zinc-900/40 border-white/5 hover:border-white/20 hover:bg-zinc-900/60 transition-all duration-300 group relative overflow-hidden"
                     >
                        ...
                        <CardContent className="p-8 md:p-10 relative z-10">
                           ...
                           <h3 className="text-lg md:text-xl font-semibold mb-3 md:mb-4 tracking-tight text-white">
                              {feature.title}
                           </h3>
         ...
         <section
            id="about"
            className="min-h-screen flex items-center justify-center overflow-hidden snap-start pt-40 pb-24 md:pt-48 md:pb-32 bg-linear-to-b from-zinc-900 to-black"
         >
            <div className="max-w-7xl mx-auto px-5 md:px-8">
               <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-20 items-center">
                     ...
                     <div className="grid grid-cols-2 gap-4 md:gap-6">
                        <div className="space-y-4 md:space-y-6 pt-8 md:pt-12">
                           <div className="aspect-square rounded-2xl bg-white/5 border border-white/10 p-6 md:p-8 flex flex-col justify-end gap-3 group hover:border-white/20 transition-all relative overflow-hidden">
                              ...
                              <div className="text-[10px] md:text-xs font-medium uppercase tracking-[0.2em] text-zinc-500">
                                 Accuracy Rate
                              </div>
                  ...
                  <div className="order-1 lg:order-2 space-y-8 md:space-y-10 text-center lg:text-left">
                     ...
                     <h2 className="text-4xl md:text-7xl font-semibold tracking-tight leading-[1.05] text-white">
                        Analisis Karir Berbasis Data
                     </h2>
                     <p className="text-lg md:text-xl text-zinc-400 font-normal leading-relaxed max-w-xl mx-auto lg:mx-0">
                        CVision menyediakan solusi untuk mempermudah pengelolaan
                        profil profesional secara digital, akurat, dan
                        terstruktur.
                     </p>
                     ...
                     <div className="grid grid-cols-2 gap-4 md:gap-5 pt-4 max-w-lg mx-auto lg:mx-0 text-left">
                        {[
                           {
                              title: "Smart Parsing",
                              desc: "Automasi data CV.",
                           },
                           {
                              title: "Job Matching",
                              desc: "Skoring relevansi.",
                           },
                           ...
                           <div
                              key={i}
                              className="flex gap-3 md:gap-4 p-4 rounded-xl border border-white/5 hover:border-white/20 transition-all group bg-zinc-900/40"
                           >
                              <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-white/5 flex items-center justify-center shrink-0 group-hover:bg-white group-hover:text-black transition-all">
                                 <CheckCircle2 className="w-4 h-4" />
                              </div>
                              <div>
                                 <div className="font-semibold text-xs md:text-sm uppercase tracking-tight text-white">
                                    {item.title}
                                 </div>
                                 <div className="text-[10px] md:text-xs text-zinc-500 font-normal">
                                    {item.desc}
                                 </div>
                              </div>
                           </div>
         ...
         <section
            id="team"
            className="min-h-screen flex items-center justify-center bg-linear-to-b from-zinc-900 to-black border-t border-white/5 snap-start pt-40 pb-24 md:pt-48 md:pb-32"
         >
            <div className="max-w-7xl mx-auto px-5 md:px-8 w-full">
               <div className="text-center space-y-4 mb-16 md:mb-24">
                  ...
                  <div className="inline-flex items-center gap-3 px-6 py-2.5 rounded-full bg-white/5 border border-white/10 shadow-sm">
                     <span className="text-[10px] md:text-xs font-medium uppercase tracking-[0.3em] text-zinc-500">
                        Capstone CC26-PSU100
                     </span>
                  </div>
               </div>
               ...
               <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {CONTRIBUTORS.map((person, idx) => (
                     <div
                        key={idx}
                        className="group relative p-6 md:p-8 rounded-2xl bg-zinc-900/40 border border-white/5 hover:border-white/20 transition-all duration-300"
                     >
                        <div className="flex items-start justify-between mb-6 md:mb-8">
                           ...
                           <div className="text-[9px] md:text-[10px] font-medium text-white/20 uppercase tracking-[0.2em] hidden sm:block">
                              {person.id}
                           </div>
                        </div>
                        <div className="space-y-1">
                           <h4 className="text-base md:text-2xl font-semibold tracking-tight truncate text-white">
                              {person.name}
                           </h4>
                           <p className="text-[10px] md:text-sm font-medium text-zinc-500 uppercase tracking-[0.2em]">
                              {person.role}
                           </p>
                        </div>
                        <div className="pt-6 md:pt-10 border-t border-white/5 flex gap-4">
                           <a
                              href="https://github.com/CC26-PSU100"
                              target="_blank"
                              rel="noopener noreferrer"
                              className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-white hover:text-black transition-all cursor-pointer"
                           >
                              <GithubIcon className="w-4 h-4 md:w-5 md:h-5 text-white" />
                           </a>
                           <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-white hover:text-black transition-all cursor-pointer text-white">
         ...
         <section className="min-h-[60vh] flex items-center justify-center snap-start pt-40 pb-24 md:pt-48 md:pb-32 relative overflow-hidden bg-linear-to-b from-zinc-900 to-black">
            ...
            <div className="max-w-4xl mx-auto px-6 md:px-8 w-full relative z-10 text-center space-y-12">
               <div className="space-y-6">
                  ...
                  <p className="text-base md:text-xl text-zinc-400 font-normal max-w-2xl mx-auto leading-relaxed">
                     Gunakan teknologi AI dari CVision untuk menganalisis
                     potensi Anda dan menemukan peluang karir yang paling
                     relevan.
                  </p>
               </div>
            ...
            <div className="absolute -top-24 -left-24 w-96 h-96 bg-white/2 rounded-full blur-[120px]" />
            <div className="absolute -bottom-24 -right-24 w-96 h-96 bg-white/2 rounded-full blur-[120px]" />
         </section>
               ...
               <div className="flex flex-col md:flex-row justify-between items-center gap-10 md:gap-12">
                  <div className="space-y-4 md:space-y-6 text-center md:text-left">
                     ...
                     <p className="max-w-xs text-xs md:text-base text-zinc-500 font-normal leading-relaxed">
                        Platform analisis karir berbasis AI.{" "}
                  ...
                  <div className="flex flex-col items-center md:items-end gap-6 md:gap-8">
                     <div className="flex gap-6 md:gap-8 text-xs font-medium uppercase tracking-[0.2em] text-zinc-500">
                        ...
                        <a
                           href="https://github.com/CC26-PSU100#readme"
                           target="_blank"
                           rel="noopener noreferrer"
                           className="hover:text-white transition-colors"
                        >
