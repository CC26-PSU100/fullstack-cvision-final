    ...
    <div className="min-h-screen w-full flex bg-background">
      <div className="hidden lg:flex lg:w-1/2 relative bg-card overflow-hidden items-center justify-center p-12 border-r border-border">
        <div className="absolute top-0 left-0 w-full h-full opacity-40">
           <div className="absolute top-[-10%] left-[-10%] w-full h-full bg-gradient-to-br from-white/10 to-transparent rounded-lg blur-3xl" />
           <div className="absolute bottom-[-10%] right-[-10%] w-full h-full bg-gradient-to-tl from-white/5 to-transparent rounded-lg blur-3xl" />
        </div>
